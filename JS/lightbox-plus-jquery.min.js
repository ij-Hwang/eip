...
!(function (a, b) {
  ...
  return (
    ...
    (b.prototype.enable = function () {
      ...
      a("body").on(
        "click",
        "a[rel^=lightbox], area[rel^=lightbox], a[data-lightbox], area[data-lightbox], span[data-lightbox]",
        function (c) {
          return b.start(a(c.currentTarget)), !b.options.stopEvent;
        }
      );
    }),
    ...
    (b.prototype.start = function (b) {
      function c(a) {
        d.album.push({
          alt: a.attr("data-alt"),
          link: a.attr("data-url") || a.attr("href"),
